...
func (_m *Redis) Get(ctx context.Context, key string) *redis.StringCmd {
...
func (_m *Redis) Set(ctx context.Context, key string, value interface{}, expiration time.Duration) *redis.StatusCmd {
