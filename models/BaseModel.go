...
//ReplaceOne finds a document using primary _id then replaces it with given values.
func (bm *BaseModel) ReplaceOne(ctx context.Context, document interface{}) error {
	bm.updated()
